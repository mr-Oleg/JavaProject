...
<div id="wrap">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center" style="font-size:200%;margin: 2%"> Здесь располагаются все имеющиеся у
                нас комнаты
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-8">
                <table class="table table-hover">
                    <tr>
                        ...
                        <td>Количество допустимых пользователей</td>
                        <td>Ставка</td>
                    </tr>
                    <#list rooms as row>
                        <tr>
